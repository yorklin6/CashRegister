...
namespace CashRegisterApplication.comm
{
    ...
    public static class CenterContral
    {
        ...
        public static DbStockOutDTORespone oStockOutDToRespond;
        ...
        //查询某天历史单据
        internal static bool GetStockOutMsgByDate(DateTime oDate, ref List<DbStockOutDTO> listStockOutDTO)
        {
            List<DbStockOutDTO> oJsonList = new List<DbStockOutDTO>();
        ...
        public static void Clean()
        {
            ...
            CenterContral.oStockOutDTO.Base.TotalPayFee = 0;
            ...
            //收款折扣
            CenterContral.oStockOutDTO.Base.discountRate = 10000;
        ...
        public static void updateOrderAmount(long orderPrice, ref DbStockOutDTO oStockOutDTO)
        {
        ...
        public static void UpdateDiscountRate(long discountRate,ref DbStockOutDTO oStockOutDTO)
        {
        ...
        public static long GetMoneyAmountByDiscountRate(DbStockOutDTO oStockOutDTO ,long discountRate)
        {
            ...
            return (long)( (double)(oStockOutDTO.Base.allGoodsMoneyAmount) /10000 * discountRate);
        }
        ...
        //***********************************取消当前订单***************************
        internal static bool CanCelOrder(DbStockOutDTO oStockOutDTO)
        {
            if (oStockOutDTO.Base.TotalPayFee == 0 && oStockOutDTO.Base.orderAmount==0 )
            {
        ...
        //***********************************删除当前订单***************************
        internal static bool DeleteOrder(DbStockOutDTO oStockOutDTO)
        {
        ...
        {
            if (CenterContral.oStockOutDTO.Base.TotalPayFee == 0 && CenterContral.oStockOutDTO.Base.orderAmount == 0)
            {
                CommUiltl.Log("Main.oStockOutDTO.details.Count == 0");
                return true;
            }
        ...
        internal static void ProductTostockDetail(ProductPricing productInfo, ref DbStockOutDetail detail)
        {
        ...
        internal static string  GetGoodsCount(DbStockOutDetail detail)
        {
            if (detail.isBarCodeMoneyGoods == CenterContral.IS_BARCODE_MOENY_GOODS)
            {
                //条码带有金额的商品,数量=总价/单价
        ...
        internal static void addStockToLocal(DbStockOutDTO oStockOutDTO)
        {
        ...
        internal static void SetStockDetailByHttpRespone(DbStockOutDTO http, ref DbStockOutDTO Db)
        {
        ...
        internal static void ShowReturanWindowByContral(DbStockOutDTO oLastStockmsg)
        {
        ...
        internal static void printOrderMsgToFile(DbStockOutDTO oStockOutDTO)
        {
            ...
            List<DbStockOutDetail> list = oStockOutDTO.details;
            ...
            sw.WriteLine("应收:" + CommUiltl.CoverMoneyUnionToStrYuan(oStockOutDTO.Base.RealRecieveFee));//实收现金
        ...
        internal static void GetLastSotckOutOrder(ref DbStockOutDTO oLastStockmsg)
        {
            DbStockOutDTO oJsonList = new DbStockOutDTO();
            //取出数据
            ...
            if (oJsonList.Base.baseDataJson == "")
            {
             ...
             oLastStockmsg = JsonConvert.DeserializeObject<DbStockOutDTO>(oJsonList.Base.baseDataJson);
        ...
        internal static void PrintLastSotckOutOrder()
        {
            ...
            DbStockOutDTO oLastStockmsg = JsonConvert.DeserializeObject<DbStockOutDTO>(oJsonList.Base.baseDataJson);

            CenterContral.PrintOrder(oLastStockmsg);
            CommUiltl.Log("PrintLastSotckOutOrder ok 打印结束");
        }
        
        internal static void PrintOrder(DbStockOutDTO oStockOutDTO)
        {
        ...
        internal static string GetStateDscByStockOutBase(DbStockOutDTO oStockOut)
        {
            if (oStockOut.Base.cloudCloseFlag == HttpUtility.CLOUD_SATE_HTTP_SUCESS)
            {
                return "成功";
            }
           
            if (oStockOut.Base.cloudCloseFlag == HttpUtility.CLOUD_SATE_HTTP_FAILD)
            {
                return "同步网络失败";
            }
            if (oStockOut.Base.cloudCloseFlag == HttpUtility.CLOUD_SATE_BUSSINESS_FAILD)
            {
                return "同步业务失败";
            }
            if (oStockOut.Base.RealRecieveFee == 0)
            {
                return "未收钱";
            }
            if (oStockOut.Base.ChangeFee < 0)
            {
                return "钱未收完";
            }
            if (oStockOut.Base.cloudCloseFlag == HttpUtility.CLOUD_SATE_HTTP_INIT)
            {
               
                return "未同步";
            }
            if (oStockOut.Base.cloudCloseFlag == Dao.STOCK_BASE_DELETE_TRUE)
            {
                return "已经删除";
            }
            return "失败";
        ...
        internal static DbStockOutDTO GetStockBySerialNumber()
        {
            throw new NotImplementedException();
        }

        internal static DbStockOutDTO GetStockBySerialNumber(string serialNumber)
        {
            throw new NotImplementedException();
        }

        internal static bool GetStockBySerialNumber(string serialNumber, ref DbStockOutDTO oStock)
        {
